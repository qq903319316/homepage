...
function $bannerOpacity(obj,btn,next,color,showcolor,date){var obj=obj,objs=$(obj).children(),btns=$(btn).children(),next=$(next).children(),color=color,showcolor=showcolor,num=0,flag=true,date=date||2000,t=setInterval(move,date);function move(){if(!flag){return}flag=false;num++;if(num>=objs.length){num=0}btns.eq(num).css({background:color}).siblings().css({background:showcolor});objs.eq(num).animate({opacity:1,zIndex:10},"slow").siblings().animate({opacity:0,zIndex:0},"slow",function(){flag=true})}$(btns).click(function(){if(!flag){return}flag=false;num=$(this).index();btns.eq(num).css({background:color}).siblings().css({background:showcolor});objs.eq(num).animate({opacity:1,zIndex:10},"slow").siblings().animate({opacity:0,zIndex:0},"slow",function(){flag=true})});obj.parent().hover(function(){clearInterval(t)},function(){t=setInterval(move,date)});$($(next[0])).click(function(){if(!flag){return}flag=false;num--;if(num<0){num=objs.length-1}btns.eq(num).css({background:color}).siblings().css({background:showcolor});objs.eq(num).animate({opacity:1,zIndex:10},"slow").siblings().animate({opacity:0,zIndex:0},"slow",function(){flag=true})});$($(next[1])).click(function(){move()})}function $bannerNext(obj,btn,next,color,showcolor,date){var obj=obj,objs=$(obj).children(),btns=$(btn).children(),next=$(next).children(),widths=objs[0].offsetWidth,color=color,showcolor=showcolor,num=0,nexts=0,date=date||2000,flag=true,t=setInterval(move,date);objs.css({left:widths}).eq(0).css({left:0});function move(){if(!flag){return}flag=false;nexts++;if(nexts>=objs.length){nexts=0}btns.eq(num).css({background:showcolor});btns.eq(nexts).css({background:color});objs.eq(num).animate({left:-widths},"slow");objs.eq(nexts).css({left:widths});objs.eq(nexts).animate({left:0},"slow",function(){flag=true});num=nexts}$(btns).click(function(){var index=$(this).index();nexts=index;if(!flag){return}flag=false;btns.eq(nexts).css({background:color}).siblings().css({background:showcolor});objs.eq(num).animate({left:-widths},"slow");
objs.eq(nexts).css({left:widths});objs.eq(nexts).animate({left:0},"slow",function(){flag=true});num=nexts});obj.parent().hover(function(){clearInterval(t)},function(){t=setInterval(move,date)});$($(next[0])).click(function(){if(!flag){return}flag=false;nexts--;if(nexts<0){nexts=objs.length-1}btns.eq(num).css({background:showcolor});btns.eq(nexts).css({background:color});objs.eq(num).animate({left:widths},"slow");objs.eq(nexts).css({left:-widths});objs.eq(nexts).animate({left:0},"slow",function(){flag=true});num=nexts});$($(next[1])).click(function(){move()})}function $bannerChild(obj,next,num,date){var obj=$(obj),next=$(next),child=obj.children(),widths=child[0].offsetWidth,num=num||20,date=date||2000,flag=true,t=setInterval(move,date);obj.css({width:(widths+num)*child.length});function move(){if(!flag){return}flag=false;obj.animate({left:-(widths+num)},"slow",function(){var first=obj.children().first();obj.append(first);obj.css({left:0});flag=true})}obj.parent().hover(function(){clearInterval(t)},function(){t=setInterval(move,date)});next.children().eq(0).click(function(){move()});next.children().eq(1).click(function(){if(!flag){return}flag=false;var first=obj.children().first();var last=obj.children().last();last.insertBefore(first);obj.css({left:-(widths+num)});obj.animate({left:0},"slow",function(){flag=true})})};
